...
cmd_not_found:
	...
	tbl->i_stat = (tbl->i_stat & ~IO_LOOKUP) | IO_PIPE;
	...
	tbl->i_stat = (tbl->i_stat & ~IO_PIPE) | IO_ADMIN1;
...
bin_fork:
	...
	tbl->i_stat = (tbl->i_stat & ~(IO_FORK|IO_ADMIN1)) | IO_CHILD_RUN;
	...
	tbl->i_stat = (tbl->i_stat & ~IO_CHILD_RUN) | IO_WAIT;
        wait(&cstat);
	tbl->i_cstat = cstat;
	tbl->i_stat = (tbl->i_stat & ~IO_WAIT) | IO_ADMIN2;
